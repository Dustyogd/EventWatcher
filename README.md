    ...
    public partial class Form1 : Form
    {
        ...
        private void StartedProcess(object sender, EventArrivedEventArgs e)
        {
            try
            {
                ...
                ProcessStart.Invoke(new Action(() => { ProcessStart.Text = ProcessStart.Text + DateTime.Now.ToString("MM/dd/yyyy hh:mm tt | ")
        ...
        private void StoppedProcess(object sender, EventArrivedEventArgs e)
        {
            try
            {
                ...
                ProcessStop.Invoke(new Action(() => { ProcessStop.Text = ProcessStop.Text + DateTime.Now.ToString("MM/dd/yyyy hh:mm tt | ") + namee.ToString() + processName.ToString() + processID.ToString(@"   ID:0") + Environment.NewLine; }));
